...
def new_full(configs):
    ...
    print(model31)
    print(model41)
    model32 = GNN_maker_HNN(graph3,2,128,8,["tanh",""],type=MODEL,bias =BIAS)
    model42 = GNN_maker_HNN(graph4,2,128,8,["tanh",""],type=MODEL,bias =BIAS)
    print(model32)
    print(model42)
    ...
    torch.save(model32,"results/model31.pt") 
