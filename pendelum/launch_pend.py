...
config_files_l = [
    'configs/pend_new.yaml'
]

# Optional arguments for Weights and Biases
wandb_options = dict(
    wandb_mode="online",  # If True, runs wandb. Default is False.
...
launcher.add_experiment(
    ...
    config__='configs/pend_new.yaml',
